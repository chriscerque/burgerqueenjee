package net.ent.etrs.burgerqueenjee.utils;
...
public final class JsfUtils {
     ...
     * @param stringFormat chaine de formatage (genre String.format()).
     * @param objects      objets à insérer dans la chaine de formatage.
     */
     ...
     * Classe : ERROR
     *
     * @param componentId identifiant JSF du composant destinataire du message.
     * @param ex          exception à envoyer.
     */
     ...
     * "id".
     *
     * @param composantId identifiant JSF du composant destinataire du message.
     ...
     * de message JSF.
     *
     * @param bundleVar  variable associée au bundle
     * @param messageKey clé du message à retourner
     */
     ...
     * "id".
     *
     * @param composantId  id JSF du composant.
     * @param severity     niveau de sévérité.
     * @param stringFormat chaine de formatage (genre String.format()).
     * @param objects      objets à insérer dans la chaine de formatage.
     */
     ...
     * FLASH de JSF 2.
     *
     * @param key  clé associée à l'objet qui est placé dans le flashScope.
     * @param data objet à placer dans le flashScope.
     */
     ...
     * @implNote CQA
     */
    public static <T> T getFromFlashScope(String key, Class<T> clazz) {
        FacesContext ctx = FacesContext.getCurrentInstance();
        Flash flash = ctx.getExternalContext().getFlash();
     ...
     *
     * @param parameterName nom du paramètre HTTP
     * @return valeur du paramètre HTTP
     */
     ...
     *
     * @param parameterName paramètre HTTP à récupérer.
     * @return valeurs du paramètre HTTP.
     */
    ...
    /**
     * Redirige vers la page passée en paramètre depuis la racine.
     *
     * @param url
     * @throws IOException
     * @implNote CQA
     */
    public static void redirectFromRoot(String url) throws IOException {
        ExternalContext ec = FacesContext.getCurrentInstance().getExternalContext();
        ec.redirect(ec.getRequestContextPath() + url);
    }

    /**
     * Retourne l'uri depuis la racine pour une requête passée en paramètre.
     *
     * @param req
     * @return
     * @implNote CQA
     */
    public static String getUriFromRoot(HttpServletRequest req) {
